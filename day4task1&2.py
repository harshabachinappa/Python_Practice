...
# kilometers = float(input("Enter the distance in kilometers: ")) #taking input in kms from user

# miles = kilometers * 0.621371 #converting kms to miles using the formula

# print(f"The distance for {kilometers} kms in miles {miles} mi.") #printing result using f strings

# output: 

# Enter the distance in kilometers: 45.8
# The distance for 45.8 kms in miles 28.4587918 mi.


#______________________XX______________________END OF PRACTICE__________________________________XX___________________________________________________
